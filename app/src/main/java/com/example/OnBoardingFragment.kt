...
import com.example.android2homework2.databinding.FragmentOnBoardingBinding
...
class OnBoardingFragment : Fragment(), OnItemClicker {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        list.add(OnBoardingModel(R.drawable.img2, "Достигай целей", "Дальше"))
        list.add(OnBoardingModel(R.drawable.img3, "Развивайся", "Начинаем"))
